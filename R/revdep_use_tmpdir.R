#' Place redepcheck's 'cache', 'check', and 'library' folders in a temporary folder
#'
...
#'
#'   1. \file{<tmpdir>/revdepcheck/<package>/revdep/cache}
#'   2. \file{<tmpdir>/revdepcheck/<package>/revdep/check}
#'   3. \file{<tmpdir>/revdepcheck/<package>/revdep/library}
#'
#' which are linked to from:
#'
#'   1. \file{<pkg>/revdep/cache}
#'   2. \file{<pkg>/revdep/check}
#'   3. \file{<pkg>/revdep/library}
#'
